...
data = pd.read_csv(r'C:\Users\fidel\Desktop\TURNO VESPERTINO\IDGS9-1\DB\parcial3\python\datos5.csv')

x = data[["Goles", "Asistencias"]].values
...
data.to_csv('Resultados_ClustersII.csv', index=False)
print('Resultados guardados en "Resultados_ClustersII.csv"')